...
class ReviewRepository {
  ...
  Future<ReviewModel?> fetchMyReview(
    ...
    try {
      final data = await _services.fetchMyReview(
  ...
  Future<List<ReviewModel>> fetchOwnerReviews(String ownerId) async {
    try {
      final data = await _services.fetchOwnerReviews(ownerId);
